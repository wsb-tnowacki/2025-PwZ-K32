...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('posty', function (Blueprint $table) {
            ...
            //Dodanie kilumny 'user_id' jako klucz obcy powiązany z tabelą 'users'
            ...
            // $table->foreign('user_id')->references('id') ->on('users')->onDelete('cascade')->after('tytul')->default(1);
    ...
    public function down(): void
    {
        ...
        Schema::table('posty', function (Blueprint $table) {
            ...
            $table->string('autor', 100)->after('tytul')->default('Tytuł przywrócony');
            $table->string('email', 200)->after('autor')->default("Treść przywrócona");
